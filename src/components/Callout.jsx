/**
 * Callout Component
 * Reusable alert box for documentation
...
/**
 * @param {Object} props
 * @param {'info'|'warning'|'error'|'success'} props.type - Callout type
...
export default function Callout({ type = 'info', title, children }) {
  ...
  return (
    <aside 
      className={clsx('callout', `callout--${type}`)}
      role="alert"
      aria-label={`${displayTitle}: ${typeof children === 'string' ? children : ''}`}
    >
